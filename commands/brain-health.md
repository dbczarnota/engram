...
1. Run the metrics engine:
   ...
   auto-vs-manual, lesson/feature accretion, `_inbox` backlog, and graphify-hint shown-vs-followed).
...
3. Propose **concrete improvements** tied to the numbers, e.g.:
   ...
   - graphify-hint shown M times, followed 0 → reconsider sub-project C (cut or change);
